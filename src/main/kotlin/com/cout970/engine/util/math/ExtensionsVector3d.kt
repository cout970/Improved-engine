...
fun mutableVec3Of(x: Number, y: Number, z: Number) = Vector3d(x.toDouble(), y.toDouble(), z.toDouble())

fun Vector3d.toImmutable() = Vector3(x, y, z)
...
operator fun Vector3d.plus(v: Vector3) =  Vector3(x + v.x, y + v.y, z + v.z)
operator fun Vector3d.minus(v: Vector3) = Vector3(x - v.x, y - v.y, z - v.z)
operator fun Vector3d.times(v: Vector3) = Vector3(x * v.x, y * v.y, z * v.z)
operator fun Vector3d.div(v: Vector3) =   Vector3(x / v.x, y / v.y, z / v.z)
